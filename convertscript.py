...
def convert(path):
    with open(path, 'rb') as jf, open("model_metadata_25-07-30.csv", "w", newline='', encoding='utf-8') as cf:
        ...
        headers=['id', 'author', 'sha', 'last_modified', 'created_at', 'private', 'gated', 'disabled', 'downloads', 'downloads_all_time', 'likes', 'library_name', 'gguf', 'inference', 'inference_provider_mapping', 'tags', 'pipeline_tag', 'mask_token', 'trending_score', 'card_data', 'widget_data', 'model_index', 'config', 'transformers_info', 'spaces', 'safetensors', 'security_repo_status', 'xet_enabled', 'lastModified', 'transformersInfo', '_id', 'modelId']
